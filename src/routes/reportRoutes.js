...
import { fakeReportRateLimiter } from "../middlewares/rateLimiter.js";

const reportRouter = Router();

// User routes
reportRouter.post("/", verifyJWT, createUserReport);
...
// Admin routes
reportRouter.post("/admin/", verifyJWT, isAdmin, addNewAdminReport);
...
reportRouter.put("/admin/:id", verifyJWT, isAdmin, updateAdminReport);
